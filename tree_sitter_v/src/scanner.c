...
#else
#error VERROR_MESSAGE Header file <tree_sitter/parser.h>, needed for module `scanner` was not found. Please install the corresponding development headers.
#endif
...
typedef enum {
	scanner__TokenType__automatic_separator, // 
} scanner__TokenType;
...
typedef void (*anon_fn_c__tslexer_bool)(TSLexer*,bool);
typedef void (*anon_fn_c__tslexer)(TSLexer*);
typedef u32 (*anon_fn_c__tslexer__u32)(TSLexer*);
typedef bool (*anon_fn_c__tslexer__bool)(TSLexer*);
// builtin types:
//------------------ #endbuiltin
...
int _const_scanner__automatic_separator; // inited later
VV_LOCAL_SYMBOL voidptr scanner__external_scanner_create();
VV_EXPORTED_SYMBOL voidptr tree_sitter_v_external_scanner_create(void); // exported fn scanner.external_scanner_create
VV_LOCAL_SYMBOL void scanner__external_scanner_destroy(voidptr p);
VV_EXPORTED_SYMBOL void tree_sitter_v_external_scanner_destroy(voidptr p); // exported fn scanner.external_scanner_destroy
VV_LOCAL_SYMBOL void scanner__external_scanner_reset(voidptr p);
VV_EXPORTED_SYMBOL void tree_sitter_v_external_scanner_reset(voidptr p); // exported fn scanner.external_scanner_reset
VV_LOCAL_SYMBOL u32 scanner__external_scanner_serialize(voidptr p, char* buffer);
VV_EXPORTED_SYMBOL u32 tree_sitter_v_external_scanner_serialize(voidptr p, char* buffer); // exported fn scanner.external_scanner_serialize
VV_LOCAL_SYMBOL void scanner__external_scanner_deserialize(voidptr p, char* b, u32 n);
VV_EXPORTED_SYMBOL void tree_sitter_v_external_scanner_deserialize(voidptr p, char* b, u32 n); // exported fn scanner.external_scanner_deserialize
VV_LOCAL_SYMBOL bool scanner__external_scanner_scan(voidptr payload, TSLexer* lexer, bool* valid_symbols);
VV_EXPORTED_SYMBOL bool tree_sitter_v_external_scanner_scan(voidptr payload, TSLexer* lexer, bool* valid_symbols); // exported fn scanner.external_scanner_scan
...
VV_LOCAL_SYMBOL voidptr map_get_and_set(map* m, voidptr key, voidptr zero) {
	...
	if (!(false)) {
		...
		v_assert_meta_info__t2.fpath = _SLIT("/Users/nedpals/Downloads/v/vlib/builtin/map.v");
...
VV_LOCAL_SYMBOL voidptr scanner__external_scanner_create(void) {
	voidptr _t1 = 0;
	return _t1;
}
// export alias: tree_sitter_v_external_scanner_create -> scanner__external_scanner_create
voidptr tree_sitter_v_external_scanner_create(void) {
	return scanner__external_scanner_create();
}
VV_LOCAL_SYMBOL void scanner__external_scanner_destroy(voidptr p) {
}
// export alias: tree_sitter_v_external_scanner_destroy -> scanner__external_scanner_destroy
void tree_sitter_v_external_scanner_destroy(voidptr p) {
	return scanner__external_scanner_destroy(p);
}
VV_LOCAL_SYMBOL void scanner__external_scanner_reset(voidptr p) {
}
// export alias: tree_sitter_v_external_scanner_reset -> scanner__external_scanner_reset
void tree_sitter_v_external_scanner_reset(voidptr p) {
	return scanner__external_scanner_reset(p);
}
VV_LOCAL_SYMBOL u32 scanner__external_scanner_serialize(voidptr p, char* buffer) {
	u32 _t1 = 0U;
	return _t1;
}
// export alias: tree_sitter_v_external_scanner_serialize -> scanner__external_scanner_serialize
u32 tree_sitter_v_external_scanner_serialize(voidptr p, char* buffer) {
	return scanner__external_scanner_serialize(p, buffer);
}
VV_LOCAL_SYMBOL void scanner__external_scanner_deserialize(voidptr p, char* b, u32 n) {
}
// export alias: tree_sitter_v_external_scanner_deserialize -> scanner__external_scanner_deserialize
void tree_sitter_v_external_scanner_deserialize(voidptr p, char* b, u32 n) {
	return scanner__external_scanner_deserialize(p, b, n);
}
VV_LOCAL_SYMBOL bool scanner__external_scanner_scan(voidptr payload, TSLexer* lexer, bool* valid_symbols) {
	bool is_newline = false;
	int tab_count = 0;
	if (valid_symbols[_const_scanner__automatic_separator]) {
		for (;;) {
		...
		bool _t1 = is_newline && needs_to_be_separated;
		return _t1;
	}
	bool _t2 = false;
	return _t2;
}
// export alias: tree_sitter_v_external_scanner_scan -> scanner__external_scanner_scan
bool tree_sitter_v_external_scanner_scan(voidptr payload, TSLexer* lexer, bool* valid_symbols) {
	return scanner__external_scanner_scan(payload, lexer, valid_symbols);
}
void _vinit(int ___argc, voidptr ___argv) {
	...
	// Initializations for module scanner :
	_const_scanner__automatic_separator = ((int)(scanner__TokenType__automatic_separator));
}
void _vcleanup() {
}
