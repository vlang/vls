...
const supertype__expression_nodes = [
	NodeType._expression_with_blocks,
	.array,
	.as_type_cast_expression,
	.binary_expression,
	.binded_identifier,
...
const supertype__simple_statement_nodes = [
	NodeType._expression,
	.assignment_statement,
	.dec_statement,
	.inc_statement,
	.short_var_declaration
...
const supertype__type_nodes = [
	NodeType._simple_type,
	.multi_return_type,
	.option_type
]

pub fn (typ NodeType) group() SuperType {
	if typ in supertype__expression_nodes {
		return SuperType.expression
	} else if typ in supertype__expression_with_blocks_nodes {
		return SuperType.expression_with_blocks
	} else if typ in supertype__simple_statement_nodes {
		return SuperType.simple_statement
	} else if typ in supertype__simple_type_nodes {
		return SuperType.simple_type
	} else if typ in supertype__statement_nodes {
		return SuperType.statement
	} else if typ in supertype__top_level_declaration_nodes {
		return SuperType.top_level_declaration
	} else if typ in supertype__type_nodes {
		return SuperType.type_
	} else {
